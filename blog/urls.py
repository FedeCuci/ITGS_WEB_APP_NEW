...
urlpatterns = [
    ...
    path('post/<int:pk>/delete/comment/', CommentDeleteView.as_view(), name='comment-delete'),
   # path('post/<int:pk>/comment/<int:pk>/', CommentDetailView.as_view(), name='comment-detail')
]
